...
/*#__PURE__*/
function () {
  function Slider(containerSelector, nextButtonSelector, prevButtonSelector, resetButtonSelector) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      try {
        if (this.nextButton) this.nextButton.forEach(function (item) {
          item.addEventListener('click', function () {
            _this2.showNextSlide();
          });
        });
        if (this.prevButton) this.prevButton.forEach(function (item) {
          item.addEventListener('click', function () {
            _this2.showPrevSlide();
          });
        });
        if (this.resetButton) this.resetButton.forEach(function (item) {
          item.addEventListener('click', function () {
            _this2.showSlide(_this2.slideIndex += -_this2.slideIndex);
          });
        });
      } catch (e) {}
    }
