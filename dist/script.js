...
function (_Slider) {
  ...
  function MainSlider(_ref) {
    ...
    var container = _ref.container,
        ...
        fadeInClass = _ref$fadeInClass === void 0 ? 'fadeIn' : _ref$fadeInClass,
        _ref$resetButton = _ref.resetButton,
        resetButton = _ref$resetButton === void 0 ? "" : _ref$resetButton;
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlide(n) {
      ...
      this.slides.forEach(function (item, i) {
        if (_this2.slideIndex == i) {
          item.classList.add(_this2.fadeInClass);
          ...
          item.classList.remove(_this2.fadeInClass);
    ...
    value: function render() {
      ...
      try {
        ...
        this.resetButton.forEach(function (item) {
          item.addEventListener('click', function () {
            _this3.showSlide(0);
          });
        });
        this.prevButton.forEach(function (item) {
          item.addEventListener('click', function () {
...
function () {
  function Slider() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        prevButton = _ref$prevButton === void 0 ? ' ' : _ref$prevButton,
        _ref$nextButton = _ref.nextButton,
        nextButton = _ref$nextButton === void 0 ? ' ' : _ref$nextButton,
        _ref$fadeInClass = _ref.fadeInClass,
        fadeInClass = _ref$fadeInClass === void 0 ? 'fadeIn' : _ref$fadeInClass;
    ...
    value: function showSlide(n) {
      ...
      this.slides.forEach(function (item, i) {
        if (_this.slideIndex == i) {
          item.classList.add(_this.fadeInClass);
          item.style.display = 'block';
        } else {
          item.classList.remove(_this.fadeInClass);
          item.style.display = 'none';
        }
      });
    }
