...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modulesPageSlide = new _modules_slider_MainSlider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function bindAction() {
      ...
      this.container.addEventListener('submit', function (e) {
        ...
        for (var i = 0; i < _this.itemsToCheck.length; i++) {
          if (!_this.itemsToCheck[i].value.length) {
            _this.showErrorBorder(_this.itemsToCheck[i]);

            break;
          } else if (_this.itemsToCheck[i].getAttribute('name') === 'phone' && _this.itemsToCheck[i].value.length !== 15) {
            _this.showErrorBorder(_this.itemsToCheck[i]);
            ...
            if (i === _this.itemsToCheck.length - 1) {
              _this.error = false;
            }
          }
        }
    ...
    key: "showErrorBorder",
    value: function showErrorBorder(item) {
    ...
    value: function postFormData(data) {
      var res;
      return regeneratorRuntime.async(function postFormData$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(fetch(this.path, {
                method: 'POST',
                body: data
              }));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LoadItems; });
/* harmony import */ var core_js_modules_es_array_filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.filter */ "./node_modules/core-js/modules/es.array.filter.js");
/* harmony import */ var core_js_modules_es_array_filter__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_filter__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_array_from__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.array.from */ "./node_modules/core-js/modules/es.array.from.js");
/* harmony import */ var core_js_modules_es_array_from__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_from__WEBPACK_IMPORTED_MODULE_1__);
...
/*#__PURE__*/
function () {
  function LoadItems(containerSelector, itemsSelector, triggerSelector) {
    var _this = this;
  ...
  _createClass(LoadItems, [{
    ...
    value: function bindTrigger() {
      ...
      this.trigger.addEventListener('click', function () {
        if (_this2.itemsToShow.length > 1) {
          _this2.itemsToShow[0].style.display = 'flex';

          _this2.itemsToShow.shift();
        } else {
          _this2.itemsToShow[0].style.display = 'flex';
...
function () {
  ...
  _createClass(Mask, [{
    key: "setCursor",
    value: function setCursor(pos, elem) {
      elem.focus();
...
function (_Slider) {
  ...
  function MainSlider() {
    ...
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        _ref$resetButton = _ref.resetButton,
        resetButton = _ref$resetButton === void 0 ? null : _ref$resetButton;

    _classCallCheck(this, MainSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, {
      container: container,
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlide(n) {
      ...
      this.slides.forEach(function (item, i) {
        if (_this2.slideIndex === i) {
          ...
          if (_this2.fadeIn) item.classList.remove(_this2.fadeIn.fadeInNext, _this2.fadeIn.fadeInPrev);
          item.style.display = 'none';
        }
      });
    }
    ...
    value: function render() {
      ...
      if (this.container) {
        this.bindAction(this.nextButton, 'click', function (e) {
          e.stopPropagation();
          e.preventDefault();

          _this3.showNextSlide();
        });
        this.bindAction(this.resetButton, 'click', function (e) {
          e.stopPropagation();
          e.preventDefault();

          _this3.showSlide(0);
        });
        this.bindAction(this.prevButton, 'click', function (e) {
          e.stopPropagation();
          e.preventDefault();

          _this3.showPrevSlide();
        });
      }
    }
  }]);
...
function (_Slider) {
  ...
  function MiniSlider() {
    ...
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        container = _ref.container,
        _ref$prevButton = _ref.prevButton,
        prevButton = _ref$prevButton === void 0 ? null : _ref$prevButton,
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, {
      container: container,
      prevButton: prevButton,
      nextButton: nextButton,
  ...
  _createClass(MiniSlider, [{
    ...
    value: function showPrevSlide(click) {
      ...
      var elementsToIgnore = this.elementsToIgnore,
          ...
          fadeIn = this.fadeIn,
          activeClass = this.activeClass;
      if (elementsToIgnore) Array.from(elementsToIgnore).reverse().forEach(function (item) {
...
function () {
  ...
  _createClass(Slider, [{
    ...
    value: function showSlide(n) {
      ...
      this.slides.forEach(function (item, i) {
        if (_this.slideIndex == i) {
          if (_this.fadeIn != {}) item.classList.add(_this.fadeIn.fadeInNext);
          item.style.display = 'block';
        } else {
          if (_this.fadeIn != {}) item.classList.remove(_this.fadeIn.fadeInNext);
          item.style.display = 'none';
        }
      });
    }
    ...
    key: "bindAction",
    value: function bindAction(item, action, callback) {
